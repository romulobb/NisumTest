...
public class UserControllerRestTemplateTest {
    ...
    @Before
    public void init() {
     //   User user = new User(1L, "Book Name", "Book Title", new BigDecimal("9.99"));
...
/*
        ...
        ResponseEntity<String> response = restTemplate.postForEntity("/books", newUser, String.class);
...
/*
        User updateUser = new User(1L, "Book Name", "Book Title", new BigDecimal("2.99"));
